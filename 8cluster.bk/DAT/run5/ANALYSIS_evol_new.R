...
file_name <- paste("/home/jam2079/DAT/matrices/",prot,"run",run,"data",nmbr,".Rdata",sep="")
...
#outfile <- paste("../../pairwise/evol/data/50ns/",dcdfile,"_pairR_ALL.dat",sep="")
...
#q(save="no")
for (sz in c(1)) {
    outfile <- paste("../../sweep/evol/data/50ns/",dcdfile,"_sweep_window_",sz,"_lig.dat",sep="")
