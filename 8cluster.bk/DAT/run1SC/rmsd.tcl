proc rmsd {reference_sel prot run} {

	set name "../../rmsd/data/$prot\_run$run\_rmsd.dat"
...
proc rmsdtm {num reference_sel prot run} {

	set name "../../rmsd/data/$prot\_run$run\_rmsd_tm_$num.dat"
	set test [file exists $name]
	if { $test == 0 } {
