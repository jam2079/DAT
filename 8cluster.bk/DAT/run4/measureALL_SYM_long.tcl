...
mol new "$prot\_run$run\_selstructure.psf"
mol addfile "$prot\_run$run\_selweialitrajectory.dcd" waitfor all
set nf [molinfo top get numframes]

# Begin loop through all the frames of the trajectory.

set glu_file [open "glu_data_long.txt" w+]
set asp_file [open "asp_data_long.txt" w+]
set arg_file [open "arg_data_long.txt" w+]
set phe_file [open "phe_data_long.txt" w+]
