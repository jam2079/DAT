...
#nmbr <- args[3]
prot <- "DAT"
#for (run in c("1","2","3","4","1BB","2BB","3BB","4BB","1SC","2SC","3SC","4SC")) {
for (run in c("1")) {
for (nmbr in c(12:71)) {
num <- nmbr
...
par(mar=c(3,4,3,5.5))
image(a,axes=FALSE,col=tim.colors(64),zlim=c(0,1),main=paste(prot,"run",run,"pairwise interactions",beg,"-",end,"ns"))
